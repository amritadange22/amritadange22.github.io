...
const routes = [
    // in case of authentication, angular checks pathmatch
    ...
    {
        path: "dashboard", loadChildren: () => __webpack_require__.e(/*! import() | moduleForLazyLoading-module-for-lazy-loading-module */ "moduleForLazyLoading-module-for-lazy-loading-module").then(__webpack_require__.bind(null, /*! ./moduleForLazyLoading/module-for-lazy-loading.module */ "./src/app/moduleForLazyLoading/module-for-lazy-loading.module.ts"))
            .then(m => m.ModuleForLazyLoadingModule)
    },
    {
...
/* harmony import */ var _shared_mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shared/mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
let HttpService = class HttpService {
    constructor(http) {
        this.http = http;
        //baseUrlEmp:string="http://localhost:8080/employee/";
    ...
    login(obj) {
        return (this.http.post(`${this.baseUrlEmp}login`, obj));
    }
    getAllEmployeeData() {
        return (this.http.get(`${this.baseUrlEmp}getAllEmployee`));
    }
    getEmployeeDataById(id) {
        return (this.http.get(`${this.baseUrlEmp}getEmployeeById?empid=${id}`));
    }
    getAllCountry() {
        return (this.http.get(`${this.baseUrlCountry}getAllCountry`));
    }
    addEmployee(obj) {
        return (this.http.post(`${this.baseUrlEmp}addEmployee`, obj, { responseType: 'text' }));
    }
    updateEmployee(obj) {
        return (this.http.put(`${this.baseUrlEmp}updateEmployee`, obj, { responseType: 'text' }));
    }
    deleteEmployee(empid) {
        return (this.http.delete(`${this.baseUrlEmp}deleteEmployeeById?empid=${empid}`, { responseType: 'text' }));
    }
    changeStatus(empid) {
        return (this.http.get(`${this.baseUrlEmp}changeStatus/${empid}`, { responseType: 'text' }));
    }
};
...
let LoginComponent = class LoginComponent {
    constructor(service, router, title) {
    ...
    onSubmit(f) {
        ...
        this.service.login(obj)
            ...
            if (this.loginObj.msg == "Invalid User" || this.loginObj.msg == "Wrong Password") {
...
/* harmony import */ var _mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
module.exports = __webpack_require__(/*! E:\Java\Java By Kiran\OJT\FrontEnd\Angular\EmployeeTracks\src\main.ts */"./src/main.ts");
